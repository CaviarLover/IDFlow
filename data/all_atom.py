...
def to_atom37(trans, rots): # trans is of shape (N, B, 3), rots is of shape (N, B, 3, 3)
    ...
    return final_atom37 # (num_batch, num_res, 37, 3) containing the 3D positions of 37 standard atoms.
