...
def dataset_creation(dataset_class, cfg, task):
    train_dataset = dataset_class(
        dataset_cfg=cfg, # cfg.pdb_dataset or cfg.scope_dataset
        task=task,
        is_training=True,
    ) 
...
def save_traj(
    ...
    sample_path = au.write_prot_to_pdb( # final prediction
        sample,
        sample_path,
        b_factors=b_factors,
        no_indexing=True,
    ...
    prot_traj_path = au.write_prot_to_pdb( # protein_trajectory
        bb_prot_traj,
        prot_traj_path,
        b_factors=b_factors,
        no_indexing=True,
    ...
    x0_traj_path = au.write_prot_to_pdb( # data projectory
        x0_traj,
        x0_traj_path,
        b_factors=b_factors,
        no_indexing=True,
